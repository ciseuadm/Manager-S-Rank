...
ответ возвращается сюда с подписью
«Ответ от Курсора». Правки пушатся прямо в main — GitHub открывать не нужно. Агент держит один диалог на сессию —
...
def _panel_text() -> str:
    return (
        ...
        "в репозиторий проекта. Правки попадут в main, Railway задеплоит сам — "
        "в GitHub заходить не нужно. Ответ вернётся с подписью «Ответ от Курсора».</i>\n"
