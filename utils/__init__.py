...
from .texts import (
    ...
    DELETE_NOTIFY, DELETE_SOFT_MSG, REVEAL_LINE, REVEAL_MEDIA_LINE,
    FLOOD_WARN, WELCOME_DEFAULT, HELP_MSG, START_MSG,
    ...
    SHOP_MSG, COMING_SOON_MSG, VIP_PROGRESS_MSG, VIP_OPEN_MSG, VIP_RANK_UNLOCK_MSG,
